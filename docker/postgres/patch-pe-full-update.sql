-- Full update of process-explorer interaction (v0.8.7 - Image Explorer)
...
@media (max-height: 300px) {
  ...
  js_code = '// Image Explorer Interaction
...
',
  ...
  config_schema = '{"fields":[{"key":"contentType","type":"select","label":"Content Type","options":[{"value":"","label":"Auto-detect (from content)"},{"value":"process","label":"Process (grid of step panels)"},{"value":"items","label":"Items (single scene with scattered objects)"}],"default":"","hint":"Choose how the image is generated. ''Process'' creates a grid with one panel per step. ''Items'' creates a single scene with all objects visible. Auto-detect analyses the input to decide."},{"key":"processTitle","type":"string","label":"Title","default":"","placeholder":"e.g. Beach Items, Water Cycle, Kitchen Tools...","description":"Name of the process or item collection being illustrated"},{"key":"processSteps","type":"string","multiline":true,"rows":8,"label":"Steps / Items (one per line)","default":"","placeholder":"Enter each step or item on a new line...","hint":"For a process: enter each step on a new line. For items: enter each item or object on a new line.","description":"Steps or items, one per line"}]}'::jsonb
