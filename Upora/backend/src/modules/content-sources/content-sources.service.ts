          ...
          if (hasTranscript) {
                ...
                if (processedOutput) {
                  ...
                  const processedOutput = this.processedContentRepository.create({
                    ...
                    outputData: {
                      ...
                      channelTitle: contentSource.metadata?.channel || null,
                      creator: contentSource.metadata?.channel || null,
            ...
            const processedOutput = this.processedContentRepository.create({
              ...
              outputData: {
                ...
                thumbnail: contentSource.metadata?.thumbnail || null,
                channel: contentSource.metadata?.channel || null,
                channelTitle: contentSource.metadata?.channel || null, // Also include as channelTitle for compatibility
                creator: contentSource.metadata?.channel || null, // Also include as creator
                duration: contentSource.metadata?.duration || null,
                metadata: {
                  title: contentSource.title || null,
                  description: contentSource.summary || null,
