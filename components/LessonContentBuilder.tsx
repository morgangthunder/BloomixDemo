        ...
        <div className="h-full flex flex-col">
            <header className="flex flex-col md:flex-row justify-between md:items-start mb-6 gap-4">
                <div>
                 ...
                 <div className="flex flex-wrap flex-col md:flex-row md:items-center justify-end gap-y-2 md:gap-x-4 text-sm text-right">
                    {/* Interaction Type */}
            ...
            <main className="flex-1 bg-brand-black rounded-lg border border-gray-700 flex items-center justify-center p-4">
