...
interface SelectOutputModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelect: (contentOutput: ContentOutput) => void;
}

const SelectOutputModal: React.FC<SelectOutputModalProps> = ({ isOpen, onClose, onSelect }) => {
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-4 pb-4 border-b border-gray-700">
          <h2 className="text-2xl font-bold text-white">Select Processed Content to View</h2>
